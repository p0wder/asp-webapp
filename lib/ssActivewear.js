...
export const STYLE_ID_MAP = {
  ...
  // NOTE: C402 (Port Authority Snapback Trucker) is a SanMar-only item; it will not resolve
  // via the S&S API and will be silently skipped during pricing lookups.
};
