...
// ── Quote-stage statuses ──────────────────────────────────────────────────────
// IDs confirmed via Printavo MCP (find_quote_invoice) or sequential inference
// from confirmed neighbours. Run scripts/find-printavo-status-id.mjs locally
// to verify any marked "inferred".
export const QUOTE_STATUS_ID                     = '256246'; // Quote
export const QUOTE_APPROVAL_SENT_STATUS_ID       = '256247'; // Quote Approval Sent — confirmed
export const QUOTE_APPROVED_STATUS_ID            = '256248'; // Quote Approved — inferred (sequential)
export const URGENT_FOLLOW_UP_ON_QUOTE_STATUS_ID = '391269'; // Urgent Follow Up on Quote — confirmed
export const QUOTE_FOLLOW_UP_COMPLETE_STATUS_ID  = null;     // TODO: run script

// ── Art / proof statuses ──────────────────────────────────────────────────────
export const ART_APPROVAL_SENT_STATUS_ID         = '256249'; // Art Approval Sent — inferred (sequential)
export const ART_APPROVED_STATUS_ID              = '256250'; // Art Approved — confirmed
export const DESIGN_NEEDED_STATUS_ID             = '433068'; // Design Needed — confirmed

// ── Production statuses ───────────────────────────────────────────────────────
export const READY_TO_ORDER_STATUS_ID            = '256605'; // Ready to Order — confirmed
export const GOODS_IN_TRANSIT_STATUS_ID          = '292756'; // Goods In Transit — confirmed
export const READY_FOR_PRODUCTION_STATUS_ID      = null;     // TODO: run script
export const IN_PRODUCTION_STATUS_ID             = null;     // TODO: run script
export const EMBROIDERY_IN_PRODUCTION_STATUS_ID  = null;     // TODO: run script

// ── Completion statuses ───────────────────────────────────────────────────────
export const COMPLETED_READY_TO_PACKAGE_STATUS_ID = null;   // TODO: run script
export const ORDER_READY_FOR_PICKUP_STATUS_ID    = null;     // TODO: run script
export const ORDER_SHIPPED_STATUS_ID             = null;     // TODO: run script
export const FEEDBACK_REQUEST_STATUS_ID          = null;     // TODO: run script
export const NEED_IT_AGAIN_STATUS_ID             = '256257'; // Need it Again? — confirmed
export const COMPLETE_STATUS_ID                  = '256802'; // Complete — confirmed

// ── Problem statuses ──────────────────────────────────────────────────────────
export const ORDER_ON_HOLD_STATUS_ID             = null;     // TODO: run script
export const INCOMPLETE_ACTION_NEEDED_STATUS_ID  = null;     // TODO: run script
