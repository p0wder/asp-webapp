...
// Run `node --env-file=.env.local scripts/find-printavo-status-id.mjs` to look
// up IDs for your account. IDs marked null must be populated before the
// quote-approval write path will work (display/token logic is unaffected).
export const QUOTE_STATUS_ID                    = '256246'; // Quote (open, un-priced)
export const QUOTE_APPROVAL_SENT_STATUS_ID      = null;     // TODO: run script
export const QUOTE_APPROVED_STATUS_ID           = null;     // TODO: run script
export const URGENT_FOLLOW_UP_ON_QUOTE_STATUS_ID = null;    // TODO: run script
export const QUOTE_FOLLOW_UP_COMPLETE_STATUS_ID = null;     // TODO: run script

// ── Art / proof statuses ──────────────────────────────────────────────────────
export const ART_APPROVAL_SENT_STATUS_ID        = null;     // TODO: run script
export const ART_APPROVED_STATUS_ID             = '256250'; // Art Approved (proof accepted)
export const DESIGN_NEEDED_STATUS_ID            = '433068'; // Design Needed (proof changes)
...
export const NEED_IT_AGAIN_STATUS_ID            = null;     // TODO: run script
export const COMPLETE_STATUS_ID                 = null;     // TODO: run script
