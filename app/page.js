  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-6 md:py-20">
      ...
      <div className="flex flex-col items-center text-center space-y-8 py-6 md:py-20">
        ...
        <Link 
          href="/quote" 
          className="bg-black text-white px-10 py-4 rounded-full text-lg font-medium hover:bg-gray-800 transition-colors mt-8"
        >
          Get Your Free Quote
        </Link>
      </div>
      ...
      {/* Features Section */}
      <div className="grid md:grid-cols-3 gap-12 py-20 border-t border-black">
