    ...
    <div className="max-w-7xl mx-auto px-6 py-16">
      ...
      <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto mb-16">
        ...
        <a
          ...
          className="p-12 transition-colors group text-center rounded-sm"
        ...
        >
          ...
          <h2 className="text-2xl font-bold mb-2" style={{ color: 'var(--foreground)' }}>Phone / Text</h2>
        ...
        >
          ...
          <h2 className="text-2xl font-bold mb-2" style={{ color: 'var(--foreground)' }}>Email</h2>
          <p className="text-xl break-all" style={{ color: 'var(--muted)' }}>
            aspmerch@gmail.com
          </p>
          <p className="text-sm mt-4" style={{ color: 'var(--muted)' }}>
      ...
      {/* Quick Quote CTA */}
      <div className="text-center pt-16" style={{ borderTop: '1px solid var(--border)' }}>
        <h2 className="text-3xl font-bold mb-4" style={{ color: 'var(--foreground)' }}>Need a Quote?</h2>
      ...
      <div className="mt-16 text-center">
        <h3 className="text-xl font-bold mb-4" style={{ color: 'var(--foreground)' }}>Business Hours</h3>
